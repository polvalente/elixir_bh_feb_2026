defmodule BeamstagramNative do
  @moduledoc """
  ...
  import BeamstagramWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {BeamstagramWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([BeamstagramWeb, CoreComponents, plugin.module_suffix])
